...
The forward host is pinned Hello Elementor plus pinned Elementor. Hello supplies the minimal theme foundation; Elementor supplies only its supported neutral `elementor_canvas` Page template. The authentic Gravity Flow shortcode or Block remains the Page content, and GPP remains the Inbox presentation owner. The fixture contains no Elementor-built Inbox cards, heading, search, summary, grid, or pager. Runtime evidence proves the theme/plugin identities, template assignment, bounded GPP surface, and absence of page-level overflow before capture.

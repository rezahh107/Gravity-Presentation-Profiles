...
$before = gpp_wu18_entry_detail_setup_state( 'before' );
register_shutdown_function(
    static function () use ( $before, $form_id, $artifact_dir ) {
        $after = gpp_wu18_entry_detail_setup_state( 'after' );
        $errors = array();
        ...
        file_put_contents(
            trailingslashit( $artifact_dir ) . 'wu18-entry-detail-setup-transition.json',

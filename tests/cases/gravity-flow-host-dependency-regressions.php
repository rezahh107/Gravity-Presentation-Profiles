...
// or action permission from its own state.
...
gpp_assert_true(
    is_string( $full_width )
        && false !== strpos( $full_width, "method_exists( 'Gravity_Flow_Entry_Detail', 'can_update' )" )
    ...
    'Full Width Review panel must retain its own fail-closed host can_update() boundary.'
);

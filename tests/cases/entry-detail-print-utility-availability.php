...
$model_loaded = $runtime->getProperty( 'model_loaded' );
...
gpp_assert_true(
    PrintDossierRuntime::utilityAvailable( array( 'id' => 10, 'form_id' => 20 ) ),
...
gpp_assert_true(
    ! PrintDossierRuntime::utilityAvailable( array( 'id' => 0, 'form_id' => 20 ) ),
